...
<head>
    ...
    <title>Agents Board - Helpdesk</title>
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-6">
                    ...
                    <nav class="flex gap-1 bg-gray-100 p-1 rounded-lg">
                        <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-white rounded-md transition-colors">
                            Status
                        </a>
